			...
			<form action="memberProc.jsp" method="get" name="f">
				<table>
					<tr height="50">
						...
						<td width="300"><input type="text" name="id" size="30"><input
							type="button" value="중복확인"
							onclick="document.location.href=goUrl()"></td>
					</tr>
					<tr height="50">
					...
					<tr height="50">
						...
						<td width="300"><input type="radio" name="gender" value="M">남자
					...
					<tr height="50">
						...
						<td width="300"><input type="text" name="birth" size="17"
							placeholder="ex)920107"></td>
					</tr>
					<tr height="50">
						<td width="200" align="center">우편번호</td>
						<td width="300"><input type="text" name="zipcode"
							id="zipcode" size="10"> <input type="button" value="찾기"
							onclick="window.open('zip.jsp','serch','width=700,height=300')"></td>
					</tr>
					<tr height="50">
					...
					<tr height="50">
						...
						<td width="300"><select name="job"><option>개발자</option>
								<option>학생</option></select></td>
					</tr>
				</table>
				<div class="fff">
					<input type="submit" value="가입" onclick="return ch()"> <input
						type="reset" value="재작성"> <a href="login.jsp"><input
